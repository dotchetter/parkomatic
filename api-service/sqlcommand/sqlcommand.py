...
if __name__ == "__main__":
    ...
    insert_message.insert_into = "table_name"
    insert_message.columns = ("lon", "lat", "device_id", "epochtime")
    insert_message.values = ("59.0000000", "18.0000000", get_device_id, 1611237337)
